...
2. run `python test.py --val test.txt` and our pre-trained weight can be download in [Googole Drive](https://drive.google.com/file/d/1pI8PJ9BSwOinF7tEqqj3JZeNDOnC2--9/view?usp=sharing) or [Baidu Yun](https://pan.baidu.com/s/1MklhfAT4oigkrrB78AARGw?pwd=shyw)
